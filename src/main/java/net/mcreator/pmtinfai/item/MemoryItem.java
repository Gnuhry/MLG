...
public class MemoryItem extends PMTINFAIElements.ModElement {
	@ObjectHolder("pmtinfai:memory")
	public static final Item block = null;
	public MemoryItem(PMTINFAIElements instance) {
		super(instance, 23);
	}
