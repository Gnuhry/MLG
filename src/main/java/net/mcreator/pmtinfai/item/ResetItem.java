...
public class ResetItem extends PMTINFAIElements.ModElement {
	@ObjectHolder("pmtinfai:reset")
	public static final Item block = null;
	public ResetItem(PMTINFAIElements instance) {
		super(instance, 26);
	}
