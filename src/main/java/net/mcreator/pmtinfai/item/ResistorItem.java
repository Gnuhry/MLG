...
public class ResistorItem extends PMTINFAIElements.ModElement {
	@ObjectHolder("pmtinfai:resistor")
	public static final Item block = null;
	public ResistorItem(PMTINFAIElements instance) {
		super(instance, 21);
	}
